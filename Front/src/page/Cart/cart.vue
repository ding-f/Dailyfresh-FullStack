                    ...
                    <div class="cart-items clearfix">
                      ...
                      <div class="items-choose">
                        <span
                          ...
                          :class="{
                            'checkbox-on':
                              selectedArry.indexOf(item.goods.id) > -1,
                          }"
                          @click="selected(item.goods.id)"
                        ></span>
                      </div>
                      <!--图片-->
                      ...
                      <div>
                        ...
                        <div class="subtotal" style="font-size: 14px">
                          ¥ {{ Number(item.goods.price) * item.nums }}
                        </div>
                        <!--数量-->
                        <buy-num
                          :num="item.nums"
  ...
  methods: {
    ...
    checkout() {
      ...
      this.$router.push({ name: "checkout",
        params: { selectedArry: JSON.stringify(this.selectedArry) } });
    },
    delChecked() {
